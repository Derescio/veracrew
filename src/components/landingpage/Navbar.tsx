  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-[#0b1120]/95 backdrop-blur-md shadow-lg shadow-black/20"
          : "bg-[#0b1120]"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            href="/auth/register"
            className="text-sm font-semibold bg-brand-blue hover:bg-brand-blue-dark text-white px-4 py-2 rounded-lg transition-colors"
          >
            Get Started
          </Link>
        </div>
